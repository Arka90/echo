  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-y-2 bg-muted p-8">
        ...
        <p className="text-muted-foreground tex-sm">Loading settings...</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex flex-col bg-muted p-8">
      <div className="max-w-screen-md mx-auto w-full">
        <div className="space-y-2">
          <h1 className="md:text-4xl text-2xl">Widget Customization</h1>
          <p className="text-muted-foreground">
            Customize your chat widget to match your brand and style.
          </p>
        </div>
        <div className="mt-8">
          <CustomizationForm
