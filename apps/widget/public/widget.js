(function () {
  "use strict";
  const o = {
      WIDGET_URL: "https://echo-widget-flame.vercel.app",
  ...
  (function () {
    ...
    function w() {
      ...
      return (i.append("organizationId", r), `${o.WIDGET_URL}?${i.toString()}`);
    }
    function f(i) {
    ...
    function v(i) {
      (x(),
        i.organizationId && (r = i.organizationId),
